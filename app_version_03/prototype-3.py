...
def main_page_content():
    ...
    window.addEventListener('beforeunload', function(e) {
        if (isProcessing) {
            e.preventDefault();
            e.returnValue = 'Your document is still being processed. Are you sure you want to leave?';
            return 'Your document is still being processed. Are you sure you want to leave?';
        }
    });

    // Functions to control the warning
    ...
    def check_processing_status():
        ...
        try:
            ...
            if status == "extracting":
                ...
                # Disable browser close warning
                ui.run_javascript('window.stopProcessing()')
    ...
    async def process_with_ai():
        ...
        ui.run_javascript('window.startProcessing()')
