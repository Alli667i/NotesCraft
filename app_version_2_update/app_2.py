...
# app.add_static_files('/assets', r"D:\Project Files\Notescraft Remastered\assets")
    ...
    'from-emerald-200 via-white to-indigo-100 px-3 sm:px-6 py-6 sm:py-12 text-base sm:text-lg'):
        ...
        with ui.card().classes(
            ...
            def handle_upload(e):
                ...
                # ✅ Respect real extension (don’t force .pdf for docx)
                suffix = Path(e.name).suffix or ".pdf"
                ...
                # ✅ Double-check file actually exists & is not empty
                if not session.uploaded_file_path.exists() or session.uploaded_file_path.stat().st_size == 0:
                    ui.notify("⚠️ Upload failed: file could not be saved correctly.", type="warning")
                    return
                ...
                with upload_container:
                    with ui.card().classes(
                        ...
                        ui.label("File Uploaded Successfully ✅").classes(
